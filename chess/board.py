...
class Board:
    def __init__(self) -> None:
        ...
        self.castling_rights_log: List[dict] = [self.castling_rights.copy()]

        # En passant target square (row, col) jumped over by a double pawn push
        self.en_passant_target: Optional[Tuple[int, int]] = None
        self.en_passant_log: List[Optional[Tuple[int, int]]] = [self.en_passant_target]
    ...
    def square_under_attack(self, r: int, c: int):
